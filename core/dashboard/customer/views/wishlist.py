...
class CustomerWishListView(LoginRequiredMixin,ListView,HasCustomerAccessPermission):
...
class CustomerWishlistDeleteView(LoginRequiredMixin,HasCustomerAccessPermission,DeleteView):
